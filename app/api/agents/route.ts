        ...
        if (!process.env.GEMINI_API_KEY) {
            return NextResponse.json({
                ...
                client: {
                    ...
                    recommendations: [
                        { text: 'Transfert privé limousine aéroport → hôtel', url: 'https://www.blacklane.com/fr/', type: 'service' },
                        { text: 'Welcome pack personnalisé avec champagne à l\'arrivée', url: null, type: 'service' },
                        { text: 'Réservation table gastronomique étoilée Michelin', url: 'https://guide.michelin.com/fr/fr/restaurants', type: 'restaurant' },
                        { text: 'Excursion privée avec guide francophone certifié', url: 'https://www.getyourguide.fr/', type: 'activité' },
                        { text: 'Soins spa couple dans une suite privée', url: null, type: 'bien-être' },
                        { text: 'Croisière privée au coucher du soleil', url: 'https://www.viator.com/fr/', type: 'activité' },
                        { text: 'Cours de cuisine locale avec chef étoilé', url: 'https://www.cookly.me/', type: 'expérience' },
                        { text: 'Shopping VIP avec personal shopper', url: null, type: 'service' },
                        { text: 'Séance photo professionnelle sur site iconique', url: 'https://www.flytographer.com/', type: 'expérience' },
                        { text: 'Surclassement suite si disponible à l\'arrivée', url: null, type: 'service' },
                    ]
                },
                itinerary: {
                    summary: `Itinéraire complet de 7 jours à ${dest}. Chaque journée est optimisée pour l'expérience.`,
                    days: [
                        { day: 1, title: 'Arrivée & Installation', destination: dest, morning: 'Transfert aéroport VIP en limousine', morningUrl: 'https://www.blacklane.com/fr/', afternoon: 'Check-in & découverte de l\'hôtel, cocktail de bienvenue', afternoonUrl: null, evening: 'Dîner de bienvenue au restaurant panoramique', eveningUrl: 'https://guide.michelin.com/fr/fr/restaurants' },
                        { day: 2, title: 'Découverte Culturelle', destination: dest, morning: 'Visite guidée privée du centre historique', morningUrl: 'https://www.getyourguide.fr/', afternoon: 'Déjeuner gastronomique local & temps libre shopping', afternoonUrl: null, evening: 'Spectacle traditionnel & dîner thématique', eveningUrl: null },
                        { day: 3, title: 'Aventure & Nature', destination: dest, morning: 'Croisière en catamaran privé', morningUrl: 'https://www.viator.com/fr/', afternoon: 'Plongée snorkeling sur récif corallien', afternoonUrl: 'https://www.tripadvisor.fr/', evening: 'Cocktails coucher de soleil sur le bateau', eveningUrl: null },
                        { day: 4, title: 'Bien-être & Relaxation', destination: dest, morning: 'Séance de yoga au lever du soleil', morningUrl: null, afternoon: 'Spa journey complète (4 soins)', afternoonUrl: null, evening: 'Dîner pieds dans le sable au restaurant étoilé', eveningUrl: 'https://guide.michelin.com/fr/fr/restaurants' },
                        { day: 5, title: 'Excursion Exclusive', destination: dest, morning: 'Hélicoptère vers site naturel exceptionnel', morningUrl: 'https://www.getyourguide.fr/', afternoon: 'Pique-nique gourmet dans un lieu secret', afternoonUrl: null, evening: 'Retour & soirée libre en ville', eveningUrl: null },
                        { day: 6, title: 'Art de Vivre Local', destination: dest, morning: 'Cours de cuisine avec chef primé', morningUrl: 'https://www.cookly.me/', afternoon: 'Visite de marché local & dégustation', afternoonUrl: null, evening: 'Dîner d\'adieu dans un lieu exclusif privatisé', eveningUrl: null },
                        { day: 7, title: 'Départ en Douceur', destination: dest, morning: 'Petit-déjeuner in-room & late check-out', morningUrl: null, afternoon: 'Transfert personnalisé vers aéroport', afternoonUrl: null, evening: 'Vol retour', eveningUrl: null },
                    ],
