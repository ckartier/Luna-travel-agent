...
import { Send, Loader2, MessageSquare, Search, Plus, Phone, Check, CheckCheck, Clock, Smile } from 'lucide-react';
...
function getChannelColor(ch: string) {
    switch (ch) {
        case 'WHATSAPP': return { bg: 'bg-green-50', text: 'text-green-600', icon: '💬', label: 'WhatsApp', border: 'border-green-100' };
        case 'EMAIL': return { bg: 'bg-blue-50', text: 'text-blue-600', icon: '📧', label: 'Email', border: 'border-blue-100' };
        case 'SMS': return { bg: 'bg-orange-50', text: 'text-orange-600', icon: '📱', label: 'SMS', border: 'border-orange-100' };
        default: return { bg: 'bg-violet-50', text: 'text-violet-600', icon: '💭', label: 'Chat', border: 'border-violet-100' };
    }
}
