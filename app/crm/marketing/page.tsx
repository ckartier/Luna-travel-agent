...
import { Plus, Search, Loader2, Megaphone, Send, BarChart3, Mail, Smartphone } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-4xl font-light text-[#2E2E2E] tracking-tight">Marketing & Campagnes</h1>
