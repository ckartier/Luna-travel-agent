    ...
    <div className="flex-1 p-4 md:p-6 overflow-y-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <button onClick={() => openNewTrip()}
          className="bg-luna-charcoal hover:bg-gray-800 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-all flex items-center gap-2 ">
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  {isSelected && (
                    <button onClick={(e) => { e.stopPropagation(); openNewTrip(dateStr); }}
                      className="w-5 h-5 rounded-full bg-luna-charcoal text-white flex items-center justify-center hover:bg-gray-800 transition-all">
                      <Plus size={12} />
                    </button>
                  )}
                </div>
              ...
              <form onSubmit={handleSave} className="p-5 flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-luna-warm-gray/10">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button type="submit"
                      className="px-5 py-2.5 bg-luna-charcoal text-white text-sm font-medium rounded-xl hover:bg-gray-800 transition-all shadow-sm flex items-center gap-2">
