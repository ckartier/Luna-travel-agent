...
import { ArrowLeft, User, Phone, Mail, Calendar, Map, CheckCircle2, Star, Hotel, Plane, FileText, Activity, Clock, ShieldCheck, Save, X, Edit3, Send, MessageCircle } from 'lucide-react';
import { CRMContact, getContacts, getTripsForContact, getLeadsForContact, updateContact, CRMTrip, CRMLead } from '@/src/lib/firebase/crm';
...
export default function ClientProfilePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (!client) return (
        <div className="text-center mt-20">
            <h1 className="text-2xl font-normal text-gray-800 mb-4">Client introuvable</h1>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                            <div>
                                {editing ? (
                                    ...
                                    <div className="flex items-center gap-3 mb-1">
                                        <h1 className="text-3xl font-normal text-luna-charcoal tracking-tight">{client.firstName} {client.lastName}</h1>
                            ...
                            <div className="flex items-center gap-3 text-sm">
                                {editing ? (
                                    ...
                                    <>
                                        {client.email && (
                                            <Link href={`/crm/inbox?compose=${encodeURIComponent(client.email)}&name=${encodeURIComponent(`${client.firstName} ${client.lastName}`)}`}
