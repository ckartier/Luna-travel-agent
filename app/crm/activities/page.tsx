    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-3">
          ...
          <button onClick={() => setIsModalOpen(true)} className="bg-luna-charcoal hover:bg-gray-800 text-white font-medium px-6 py-2.5 rounded-xl transition-all flex items-center gap-2 text-sm">
            + Nouvelle Tâche
          </button>
        </div>
      </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-lg shadow-luxury overflow-hidden">
            ...
            <form onSubmit={handleAddTask} className="p-6 space-y-4">
              ...
              <div className="pt-4 flex justify-end gap-3">
                ...
                <button type="submit" className="bg-luna-charcoal hover:bg-gray-800 text-white font-medium px-6 py-2.5 rounded-xltransition-all">Sauvegarder</button>
              </div>
            </form>
          </div>
        </div>
