    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#faf8f5] to-white">
            ...
            <article className="max-w-3xl mx-auto px-6 py-12 prose prose-gray prose-headings:font-serif prose-headings:text-luna-charcoal">
                ...
                <h3>4.1 Formules</h3>
                <p>Quatre formules d'abonnement sont proposées :</p>
                <ul>
                    <li><strong>Site Builder (29€/mois)</strong> : Site vitrine professionnel, 3 templates, éditeur visuel, formulaire sur-mesure</li>
                    <li><strong>CRM Pro (79€/mois)</strong> : CRM complet, pipeline, contacts, planning, devis & factures, 5 membres d'équipe</li>
                    <li><strong>All-in-One (99€/mois)</strong> : Site + CRM, analytics avancés, 15 membres, 2000 contacts, 200 voyages/mois</li>
                    <li><strong>Enterprise (499€/mois)</strong> : Agents IA illimités, WhatsApp Business, API complète, SLA 99.9%, support dédié</li>
                </ul>
