...
export function MapBackground() {
    ...
    return (
        <div className="absolute inset-0 w-full h-full bg-[#e8e2da] -z-10 overflow-hidden pointer-events-none">
                            ...
                            <Marker key={plane.id} longitude={plane.lng} latitude={plane.lat} anchor="center">
                                <div className="flex flex-col items-center gap-1">
                                    ...
                                    >
                                        ...
                                        <div
                                            className="absolute h-[60px] w-[2px] bg-gradient-to-t from-transparent to-[#b8956a]/50 blur-[1px]"
                                            style={{
                                        ...
                                        {/* Airplane glow */}
                                        <div className="absolute w-8 h-8 bg-[#b8956a]/20 rounded-full blur-md"></div>

                                        <Plane
                                            className="w-5 h-5 text-[#8b6f47] relative z-10 drop-shadow-[0_0_6px_rgba(184,149,106,0.6)]"
                        ...
                        return (
                            <div key={plane.id} className="absolute flex flex-col items-center gap-1" style={{ top, left }}>
                                <motion.div animate={{ y: [0, -10, 0], x: [0, 5, 0] }} transition={{ repeat: Infinity, duration: 4 + Math.random() * 2, ease: "easeInOut" }}>
                                    <Plane className="w-5 h-5 text-[#8b6f47] drop-shadow-md" style={{ transform: `rotate(${plane.rotate}deg)` }} fill="currentColor" />
                                </motion.div>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#d4c5b0] rounded-full blur-[100px] opacity-30 mix-blend-multiply pointer-events-none" />
